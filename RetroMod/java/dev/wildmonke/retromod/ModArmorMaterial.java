...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    LYNCH("lynch", 70, new int[]{5, 8, 10, 6}, 15, SoundEvents.ARMOR_EQUIP_DIAMOND, 3.0F, 0.1F, () -> {
        return Ingredient.of(ItemInit.LYNCH_INGOT.get());
    });
    ...
    public String getName() {
        ...
        return RetroMod.MODID + ":" + this.name;
    }
